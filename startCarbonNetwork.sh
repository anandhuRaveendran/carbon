...
export CHANNEL_NAME=carbonchain
...
export ORDERER_CA=${PWD}/organizations/ordererOrganizations/carbon.com/orderers/orderer.carbon.com/msp/tlscacerts/tlsca.carbon.com-cert.pem
export ORDERER_ADMIN_TLS_SIGN_CERT=${PWD}/organizations/ordererOrganizations/carbon.com/orderers/orderer.carbon.com/tls/server.crt

export ORDERER_ADMIN_TLS_PRIVATE_KEY=${PWD}/organizations/ordererOrganizations/carbon.com/orderers/orderer.carbon.com/tls/server.key
...
echo "—-------------carbon anchor peer update—-----------"
